...
class TestPinta:
    """Tests para el enum Pinta con las denominaciones tradicionales del Dudo."""
    ...
    def test_pinta_valores_numericos_correctos(self):
        """Test que verifica que cada pinta tiene el valor numérico correcto."""
...
class TestDado:
    ...
    def test_dado_show_retorna_pinta(self):
        """Test que verifica que el método show retorna una instancia de Pinta (Pinta actual)."""
        dado = Dado()
        pinta = dado.show()
